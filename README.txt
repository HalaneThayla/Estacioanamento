...
Proposta
 ...
 ![Diagrama da Classe Estacionamento](img/diagrama_classe_estacionamento.png)
...
Por fim, implementei um menu interativo com as seguintes opções:
Cadastrar veículo
...
Solução
 A solução desenvolvida atendeu ao desafio, aplicando conceitos fundamentais de programação orientada a objetos, listas e interação com o usuário no console.
